...
type FakeActivatableStore struct {
	...
	IsActivatedStub        func() (bool, error)
	isActivatedMutex       sync.RWMutex
	isActivatedArgsForCall []struct{}
	isActivatedReturns     struct {
		result1 bool
		result2 error
	}
	isActivatedReturnsOnCall map[int]struct {
		result1 bool
		result2 error
	}
...
func (fake *FakeActivatableStore) Activate() error {
...
func (fake *FakeActivatableStore) ActivateCallCount() int {
	fake.activateMutex.RLock()
	defer fake.activateMutex.RUnlock()
	return len(fake.activateArgsForCall)
}

func (fake *FakeActivatableStore) ActivateReturns(result1 error) {
...
func (fake *FakeActivatableStore) ActivateReturnsOnCall(i int, result1 error) {
	fake.ActivateStub = nil
...
func (fake *FakeActivatableStore) IsActivated() (bool, error) {
	fake.isActivatedMutex.Lock()
	ret, specificReturn := fake.isActivatedReturnsOnCall[len(fake.isActivatedArgsForCall)]
	fake.isActivatedArgsForCall = append(fake.isActivatedArgsForCall, struct{}{})
	fake.recordInvocation("IsActivated", []interface{}{})
	fake.isActivatedMutex.Unlock()
	if fake.IsActivatedStub != nil {
		return fake.IsActivatedStub()
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.isActivatedReturns.result1, fake.isActivatedReturns.result2
}

func (fake *FakeActivatableStore) IsActivatedCallCount() int {
	fake.isActivatedMutex.RLock()
	defer fake.isActivatedMutex.RUnlock()
	return len(fake.isActivatedArgsForCall)
}

func (fake *FakeActivatableStore) IsActivatedReturns(result1 bool, result2 error) {
	fake.IsActivatedStub = nil
	fake.isActivatedReturns = struct {
		result1 bool
		result2 error
	}{result1, result2}
}

func (fake *FakeActivatableStore) IsActivatedReturnsOnCall(i int, result1 bool, result2 error) {
	fake.IsActivatedStub = nil
	if fake.isActivatedReturnsOnCall == nil {
		fake.isActivatedReturnsOnCall = make(map[int]struct {
			result1 bool
			result2 error
		})
	}
	fake.isActivatedReturnsOnCall[i] = struct {
		result1 bool
		result2 error
	}{result1, result2}
}

func (fake *FakeActivatableStore) RetrieveInstanceDetails(id string) (brokerstore.ServiceInstance, error) {
...
func (fake *FakeActivatableStore) RetrieveInstanceDetailsCallCount() int {
...
func (fake *FakeActivatableStore) RetrieveInstanceDetailsArgsForCall(i int) string {
	fake.retrieveInstanceDetailsMutex.RLock()
	defer fake.retrieveInstanceDetailsMutex.RUnlock()
	return fake.retrieveInstanceDetailsArgsForCall[i].id
}

func (fake *FakeActivatableStore) RetrieveInstanceDetailsReturns(result1 brokerstore.ServiceInstance, result2 error) {
...
func (fake *FakeActivatableStore) RetrieveInstanceDetailsReturnsOnCall(i int, result1 brokerstore.ServiceInstance, result2 error) {
	fake.RetrieveInstanceDetailsStub = nil
...
func (fake *FakeActivatableStore) RetrieveBindingDetails(id string) (brokerapi.BindDetails, error) {
...
func (fake *FakeActivatableStore) RetrieveBindingDetailsCallCount() int {
...
func (fake *FakeActivatableStore) RetrieveBindingDetailsArgsForCall(i int) string {
	fake.retrieveBindingDetailsMutex.RLock()
	defer fake.retrieveBindingDetailsMutex.RUnlock()
	return fake.retrieveBindingDetailsArgsForCall[i].id
}

func (fake *FakeActivatableStore) RetrieveBindingDetailsReturns(result1 brokerapi.BindDetails, result2 error) {
...
func (fake *FakeActivatableStore) RetrieveBindingDetailsReturnsOnCall(i int, result1 brokerapi.BindDetails, result2 error) {
	fake.RetrieveBindingDetailsStub = nil
...
func (fake *FakeActivatableStore) RetrieveAllInstanceDetails() (map[string]brokerstore.ServiceInstance, error) {
...
func (fake *FakeActivatableStore) RetrieveAllInstanceDetailsCallCount() int {
...
func (fake *FakeActivatableStore) RetrieveAllInstanceDetailsReturns(result1 map[string]brokerstore.ServiceInstance, result2 error) {
...
func (fake *FakeActivatableStore) RetrieveAllInstanceDetailsReturnsOnCall(i int, result1 map[string]brokerstore.ServiceInstance, result2 error) {
	fake.RetrieveAllInstanceDetailsStub = nil
...
func (fake *FakeActivatableStore) RetrieveAllBindingDetails() (map[string]brokerapi.BindDetails, error) {
...
func (fake *FakeActivatableStore) RetrieveAllBindingDetailsCallCount() int {
...
func (fake *FakeActivatableStore) RetrieveAllBindingDetailsReturns(result1 map[string]brokerapi.BindDetails, result2 error) {
...
func (fake *FakeActivatableStore) RetrieveAllBindingDetailsReturnsOnCall(i int, result1 map[string]brokerapi.BindDetails, result2 error) {
	fake.RetrieveAllBindingDetailsStub = nil
...
func (fake *FakeActivatableStore) CreateInstanceDetails(id string, details brokerstore.ServiceInstance) error {
...
func (fake *FakeActivatableStore) CreateInstanceDetailsCallCount() int {
...
func (fake *FakeActivatableStore) CreateInstanceDetailsArgsForCall(i int) (string, brokerstore.ServiceInstance) {
	fake.createInstanceDetailsMutex.RLock()
	defer fake.createInstanceDetailsMutex.RUnlock()
	return fake.createInstanceDetailsArgsForCall[i].id, fake.createInstanceDetailsArgsForCall[i].details
}

func (fake *FakeActivatableStore) CreateInstanceDetailsReturns(result1 error) {
...
func (fake *FakeActivatableStore) CreateInstanceDetailsReturnsOnCall(i int, result1 error) {
	fake.CreateInstanceDetailsStub = nil
...
func (fake *FakeActivatableStore) CreateBindingDetails(id string, details brokerapi.BindDetails) error {
...
func (fake *FakeActivatableStore) CreateBindingDetailsCallCount() int {
...
func (fake *FakeActivatableStore) CreateBindingDetailsArgsForCall(i int) (string, brokerapi.BindDetails) {
	fake.createBindingDetailsMutex.RLock()
	defer fake.createBindingDetailsMutex.RUnlock()
	return fake.createBindingDetailsArgsForCall[i].id, fake.createBindingDetailsArgsForCall[i].details
}

func (fake *FakeActivatableStore) CreateBindingDetailsReturns(result1 error) {
...
func (fake *FakeActivatableStore) CreateBindingDetailsReturnsOnCall(i int, result1 error) {
	fake.CreateBindingDetailsStub = nil
...
func (fake *FakeActivatableStore) DeleteInstanceDetails(id string) error {
...
func (fake *FakeActivatableStore) DeleteInstanceDetailsCallCount() int {
...
func (fake *FakeActivatableStore) DeleteInstanceDetailsArgsForCall(i int) string {
	fake.deleteInstanceDetailsMutex.RLock()
	defer fake.deleteInstanceDetailsMutex.RUnlock()
	return fake.deleteInstanceDetailsArgsForCall[i].id
}

func (fake *FakeActivatableStore) DeleteInstanceDetailsReturns(result1 error) {
...
func (fake *FakeActivatableStore) DeleteInstanceDetailsReturnsOnCall(i int, result1 error) {
	fake.DeleteInstanceDetailsStub = nil
...
func (fake *FakeActivatableStore) DeleteBindingDetails(id string) error {
...
func (fake *FakeActivatableStore) DeleteBindingDetailsCallCount() int {
...
func (fake *FakeActivatableStore) DeleteBindingDetailsArgsForCall(i int) string {
	fake.deleteBindingDetailsMutex.RLock()
	defer fake.deleteBindingDetailsMutex.RUnlock()
	return fake.deleteBindingDetailsArgsForCall[i].id
}

func (fake *FakeActivatableStore) DeleteBindingDetailsReturns(result1 error) {
...
func (fake *FakeActivatableStore) DeleteBindingDetailsReturnsOnCall(i int, result1 error) {
	fake.DeleteBindingDetailsStub = nil
...
func (fake *FakeActivatableStore) IsInstanceConflict(id string, details brokerstore.ServiceInstance) bool {
...
func (fake *FakeActivatableStore) IsInstanceConflictCallCount() int {
...
func (fake *FakeActivatableStore) IsInstanceConflictArgsForCall(i int) (string, brokerstore.ServiceInstance) {
	fake.isInstanceConflictMutex.RLock()
	defer fake.isInstanceConflictMutex.RUnlock()
	return fake.isInstanceConflictArgsForCall[i].id, fake.isInstanceConflictArgsForCall[i].details
}

func (fake *FakeActivatableStore) IsInstanceConflictReturns(result1 bool) {
...
func (fake *FakeActivatableStore) IsInstanceConflictReturnsOnCall(i int, result1 bool) {
	fake.IsInstanceConflictStub = nil
...
func (fake *FakeActivatableStore) IsBindingConflict(id string, details brokerapi.BindDetails) bool {
...
func (fake *FakeActivatableStore) IsBindingConflictCallCount() int {
	fake.isBindingConflictMutex.RLock()
	defer fake.isBindingConflictMutex.RUnlock()
	return len(fake.isBindingConflictArgsForCall)
}

func (fake *FakeActivatableStore) IsBindingConflictArgsForCall(i int) (string, brokerapi.BindDetails) {
	fake.isBindingConflictMutex.RLock()
	defer fake.isBindingConflictMutex.RUnlock()
	return fake.isBindingConflictArgsForCall[i].id, fake.isBindingConflictArgsForCall[i].details
}

func (fake *FakeActivatableStore) IsBindingConflictReturns(result1 bool) {
...
func (fake *FakeActivatableStore) IsBindingConflictReturnsOnCall(i int, result1 bool) {
	fake.IsBindingConflictStub = nil
...
func (fake *FakeActivatableStore) Restore(logger lager.Logger) error {
...
func (fake *FakeActivatableStore) RestoreCallCount() int {
	fake.restoreMutex.RLock()
	defer fake.restoreMutex.RUnlock()
	return len(fake.restoreArgsForCall)
}

func (fake *FakeActivatableStore) RestoreArgsForCall(i int) lager.Logger {
	fake.restoreMutex.RLock()
	defer fake.restoreMutex.RUnlock()
	return fake.restoreArgsForCall[i].logger
}

func (fake *FakeActivatableStore) RestoreReturns(result1 error) {
...
func (fake *FakeActivatableStore) RestoreReturnsOnCall(i int, result1 error) {
	fake.RestoreStub = nil
...
func (fake *FakeActivatableStore) Save(logger lager.Logger) error {
	fake.saveMutex.Lock()
...
func (fake *FakeActivatableStore) SaveCallCount() int {
	fake.saveMutex.RLock()
	defer fake.saveMutex.RUnlock()
	return len(fake.saveArgsForCall)
}

func (fake *FakeActivatableStore) SaveArgsForCall(i int) lager.Logger {
	fake.saveMutex.RLock()
	defer fake.saveMutex.RUnlock()
	return fake.saveArgsForCall[i].logger
}

func (fake *FakeActivatableStore) SaveReturns(result1 error) {
	fake.SaveStub = nil
...
func (fake *FakeActivatableStore) SaveReturnsOnCall(i int, result1 error) {
	fake.SaveStub = nil
...
func (fake *FakeActivatableStore) Cleanup() error {
...
func (fake *FakeActivatableStore) CleanupCallCount() int {
	fake.cleanupMutex.RLock()
	defer fake.cleanupMutex.RUnlock()
	return len(fake.cleanupArgsForCall)
}

func (fake *FakeActivatableStore) CleanupReturns(result1 error) {
...
func (fake *FakeActivatableStore) CleanupReturnsOnCall(i int, result1 error) {
	fake.CleanupStub = nil
...
func (fake *FakeActivatableStore) Invocations() map[string][][]interface{} {
...
func (fake *FakeActivatableStore) recordInvocation(key string, args []interface{}) {
...
var _ migrator.ActivatableStore = new(FakeActivatableStore)
